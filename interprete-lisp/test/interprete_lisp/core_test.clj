...
(deftest evaluar-escalar-test
  (testing "Prueba de la funcion: evaluar-escalar"
    ...
    (is (= '(add (+ add w 3 x 6)) (evaluar-escalar '+ '(+ add w 3 x 6) '(x 5 y 11 z "hola"))))
...
(deftest evaluar-setq-test
  (testing "Prueba de la funcion: evaluar-setq"
    ...
    (is (=  '((*error* list expected nil) (nil nil t t + add w 5 x 7)) (evaluar-setq '(setq x 7 y) '(nil nil t t + add w 5 x 4) '(x 1 y nil z 3))))
    (is (=  '(9 (nil nil t t + add w 5 x 7 y 8 z 9)) (evaluar-setq '(setq x 7 y 8 z 9) '(nil nil t t + add w 5 x 4) '(x 1 y nil z 3))))
  )
)